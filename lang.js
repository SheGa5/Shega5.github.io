  ...
  var translations = {
    cs: {
      ...
      "hero.eyebrow": "Kudrnova 234/6 · Praha 5 – Motol",
      ...
      "dish2.pannacotta": "Panna cotta s ovocem",
      ...
      "dish.springroll": "Jarní závitky (spring rolls)",
      ...
      "order.woltCta": "Objednat na Woltu →",
      ...
      "menu2.draftHeading": "Točené pivo",
      "menu2.houseSpecial": "Specialita podniku",
      "menu2.softHeading": "Nealko",
      "menu2.bottledAlcoholHeading": "Lahvové alko",
      ...
      "story.videoCaption": "Focení našeho menu v prostorech restaurace, pro společnost Wolt",
    ...
    en: {
      ...
      "hero.eyebrow": "Kudrnova 234/6 · Prague 5 – Motol",
      ...
      "dish.beefbroth_go": "Beef broth with noodles",
      "dish.friedrice": "Fried rice (chicken, shrimp)",
      "dish.noodlesoup": "Thai beef noodle soup",
      "dish.greencurry": "Chicken curry with rice",
      ...
      "menu2.draftHeading": "Draft beer",
      "menu2.houseSpecial": "House special",
      "menu2.softHeading": "Soft drinks",
      "menu2.bottledAlcoholHeading": "Bottled alcohol",
      ...
      "story.videoCaption": "Shooting our menu in the restaurant, for Wolt",
    ...
    fr: {
      ...
      "dish.springroll": "Rouleaux de printemps",
      ...
      "order.woltCta": "Commander sur Wolt →",
      ...
      "menu2.draftHeading": "Bière pression",
      "menu2.houseSpecial": "Spécialité de la maison",
      "menu2.softHeading": "Sans alcool",
      "menu2.bottledAlcoholHeading": "Alcools en bouteille",
      ...
      "story.videoCaption": "Séance photo de notre menu au restaurant, pour Wolt",
    ...
    uk: {
      ...
      "hero.eyebrow": "Kudrnova 234/6 · Прага 5 – Мотол",
      ...
      "order.woltCta": "Замовити на Wolt →",
      ...
      "menu2.draftHeading": "Розливне пиво",
      "menu2.houseSpecial": "Спеціалітет закладу",
      "menu2.softHeading": "Безалкогольні",
      "menu2.bottledAlcoholHeading": "Алкоголь у пляшках",
      ...
      "story.videoCaption": "Зйомка нашого меню в ресторані, для Wolt",
    ...
    vi: {
      ...
      "menu2.draftHeading": "Bia tươi",
      "menu2.houseSpecial": "Đặc sản của quán",
      "menu2.softHeading": "Nước ngọt",
      "menu2.bottledAlcoholHeading": "Đồ uống có cồn (chai)",
      ...
      "story.videoCaption": "Chụp ảnh thực đơn của chúng tôi tại nhà hàng, cho Wolt",
    ...
    th: {
      ...
      "dish.beefbroth_go": "ซุปเนื้อใส่เส้นก๋วยเตี๋ยว",
      "dish.friedrice": "ข้าวผัด (ไก่ กุ้ง)",
      "dish.noodlesoup": "ก๋วยเตี๋ยวเนื้อสไตล์ไทย",
      "dish.greencurry": "แกงไก่ กับข้าว",
      ...
      "menu2.draftHeading": "เบียร์สด",
      "menu2.houseSpecial": "ของเด่นประจำร้าน",
      "menu2.softHeading": "เครื่องดื่มไม่มีแอลกอฮอล์",
      "menu2.bottledAlcoholHeading": "แอลกอฮอล์แบบขวด",
      ...
      "story.videoCaption": "ถ่ายภาพเมนูของเราภายในร้าน สำหรับ Wolt",
