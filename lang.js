  ...
  var translations = {
    cs: {
      ...
      "dish.springroll": "Jarní závitky (kuřecí), 3 ks",
    ...
    en: {
      ...
      "dish.springroll": "Spring rolls (chicken), 3 pcs",
    ...
    fr: {
      ...
      "dish.springroll": "Rouleaux de printemps (poulet), 3 pcs",
    ...
    uk: {
      ...
      "dish.springroll": "Спрінг-роли (курячі), 3 шт",
    ...
    vi: {
      ...
      "dish.springroll": "Chả giò (gà), 3 cái",
    ...
    th: {
      ...
      "dish.springroll": "ปอเปี๊ยะทอด (ไก่) 3 ชิ้น",
